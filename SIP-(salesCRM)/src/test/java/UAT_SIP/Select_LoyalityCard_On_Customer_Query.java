...
public class Select_LoyalityCard_On_Customer_Query  {
	 String  LoyalityCard ;  // Selected Fillter
  ...
  //..................................................................................................
    ...
    public void SMR() throws InterruptedException {
        this.driver = Select_MarutiInsurance_On_Customer_Query.driver;	    
        }      
    ...
    @Test(priority = 6)
  	...
  	//.............................................................................................    
      @Test(priority = 7)
        public void Click_On_Select_LoyalityCard() throws InterruptedException {	       	    
        ...
        WebElement Select = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[text()=\"Select\"]")));
  	    ...
  	    Thread.sleep(2000);
  	    // selected Product 
  	    WebElement Select_Maruti_Insurance  = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("(//mat-option[contains(@id, 'mat-option-')])[6]"))); 	   
  	    LoyalityCard =Select_Maruti_Insurance .getText();
  	    System.out.println(" LoyalityCard      == "+ LoyalityCard ); 	    
  	    clickElementUsingJS(driver, Select_Maruti_Insurance);  // select maruti Insurance
	    
	    Thread.sleep(2000);
	    Query="LoyalityCard";	  // Query remarks have to match in view details.  
      ...
      @Test(priority = 8)
	   ...
	   System.out.println("CATEGORY of LoyalityCard -:"+CATEGORY);
	   ...
	   System.out.println("CRE_Remarks of LoyalityCard :: "+CRE_Remarks);
	    ...
	    Thread.sleep(2000);
  	    ...
  	    System.out.println("STATUS of LoyalityCard  -:"+STATUS2);
  	    Thread.sleep(2000);
  	  }
   //......................................................................................   
      @Test(priority = 9)
      public void Match_ExtendWarranty_Query_will_punched() throws InterruptedException {	
    	  Thread.sleep(500);
    	  Assert.assertEquals(LoyalityCard, CATEGORY," Selected 'LoyalityCard' does not show in 'Category' after Click on Query history ");
