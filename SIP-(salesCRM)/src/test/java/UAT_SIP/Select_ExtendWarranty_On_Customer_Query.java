...
public class Select_ExtendWarranty_On_Customer_Query  {
	 String  ExtendWarranty ;  // Selected Fillter
    ...
    public void SMR() throws InterruptedException {
        this.driver = Select_Payment_On_Customer_Query.driver;	    
        }
//..................................................................................................
    ...
    @Test(priority = 6)
  	...
  	//.............................................................................................    
      @Test(priority = 7)
        public void Click_On_Select_ExtendWarranty() throws InterruptedException {	       	    
        ...
        WebElement Select = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[text()=\"Select\"]")));
  	    ...
  	    Thread.sleep(2000);
  	    // selected Product 
  	    WebElement Select_ExtendWarranty  = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("(//mat-option[contains(@id, 'mat-option-')])[4]"))); 	   
  	    ExtendWarranty =Select_ExtendWarranty .getText();
  	    System.out.println(" ExtendWarranty      == "+ ExtendWarranty ); 	    
  	    clickElementUsingJS(driver, Select_ExtendWarranty);
	    
	    Thread.sleep(2000);
	    Query="ExtendWarranty";	  // Query remarks have to match in view details.  
      ...
      @Test(priority = 8)
	   ...
	   System.out.println("CATEGORY of extend Warranty -:"+CATEGORY);
	   ...
	   System.out.println("CRE_Remarks of extend Warranty :: "+CRE_Remarks);
	    ...
	    Thread.sleep(2000);
  	    ...
  	    System.out.println("STATUS of extend Warranty  -:"+STATUS2);
  	    Thread.sleep(2000);
  	  }
   //......................................................................................   
      @Test(priority = 9)
      public void Match_ExtendWarranty_Query_will_punched() throws InterruptedException {	
    	  Thread.sleep(500);
    	  Assert.assertEquals(ExtendWarranty, CATEGORY," Selected 'ExtendWarranty' does not show in 'Category' after Click on Query history ");
